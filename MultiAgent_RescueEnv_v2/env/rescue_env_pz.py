"""
rescue_env_pz.py - PettingZoo wrapper, parametric.
"""
...
class RescueEnvPZ(ParallelEnv):
    metadata = {"render_modes": [None], "name": "rescue_v3"}

    def __init__(self, size, max_cycles=200, num_fires=2,
                 wall_density=0.10, random_walls=True,
                 view_size=None, seed=None):
        self.size = size
        self.max_cycles = max_cycles
        self._step_count = 0
        self._env = SimpleGridWorld(
            size=size, num_fires=num_fires,
            wall_density=wall_density, random_walls=random_walls,
