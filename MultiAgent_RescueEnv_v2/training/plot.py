...
def load_and_plot(seed, save_dir):
    ...
    experiments_to_load = [
    {"id": 1, "folder": "exp_1_L24_sparse", "label": "L24 - SPARSE (no shaping)"},
    {"id": 2, "folder": "exp_2_L12_sparse", "label": "L12 - SPARSE (no shaping)"},
    {"id": 3, "folder": "exp_3_L6_sparse",  "label": "L6 - SPARSE (no shaping)"},
    {"id": 4, "folder": "exp_4_L3_sparse",  "label": "L3 - SPARSE (base case)"},
    {"id": 5, "folder": "exp_5_L6_hier",    "label": "L6 - HIERARCHICAL (shaping from V*_3)"},
    {"id": 6, "folder": "exp_6_L12_hier",   "label": "L12 - HIERARCHICAL (shaping from V*_6)"},
    {"id": 7, "folder": "exp_7_L24_hier",   "label": "L24 - HIERARCHICAL (shaping from V*_12)"},
]
...
if __name__ == "__main__":
    ...
    SAVE_DIR = os.path.join(PROJECT_ROOT, "results_24x24_2run/")
