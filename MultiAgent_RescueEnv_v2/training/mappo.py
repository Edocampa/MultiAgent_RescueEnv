"""
mappo.py - Multi-Agent PPO with optional dual learner.

dual_learner=True implements Algorithm 1 of Cipollone et al:
    ...
    Actions sampled from BIASED actors (faster exploration).
    The UNBIASED actors are the final policy (paper's optimality guarantee).

dual_learner=False: single learner (sparse experiments).
"""
...
class MAPPO:
    def __init__(
        self, num_agents=2, obs_dim=35, global_dim=110, action_dim=5,
